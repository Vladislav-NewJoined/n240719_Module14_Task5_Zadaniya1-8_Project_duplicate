...
public class PhotoMessageUtils {
    public static List<String> savePhotos(List<File> files, String botToken) throws IOException {
        ...
        for (File file: files) {
            ...
            final String localFileName = "src/main/java/task9_8_1_part4/images/" + new Date().getTime() + random.nextLong() + ".jpeg";
