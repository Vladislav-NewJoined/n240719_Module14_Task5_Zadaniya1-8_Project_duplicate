...
//// из ПРИМЕРа 4 _Промежуточный. Всё работает. До 10 58 мин в видео. До создания метода SendPhoto runPhotoFilter
...
// из ПРИМЕРа 8 _Получившийся код по итогу после просмотра всего видео 08. Но не работает. Возвращается
...
//// из ПРИМЕРа 6 _Промежуточный. Всё работает. Пройдена 26 19 мин
//// Дорабатываем Пример 3 _РАБОТАЕТ! Создаёт 3 кнопки и обрабатывает их, и создаёт лишнюю надпись "Команда не из кнопки".
//// И обрабатывает только одно изображение _Использован бот №2
//import org.telegram.telegrambots.bots.TelegramLongPollingBot;
//import org.telegram.telegrambots.meta.api.methods.GetFile;
...
//// ПРИМЕР 8 _Получившийся код по итогу после просмотра всего видео 08. Но не работает. Возвращается
//// только одно изображение, и кажется кнопки не создаёт
// Дорабатываем Пример 3 _РАБОТАЕТ! Создаёт 3 кнопки и обрабатывает их, и создаёт лишнюю надпись "Команда не из кнопки".
// И обрабатывает только одно изображение _Использован бот №2
//import org.telegram.telegrambots.bots.TelegramLongPollingBot;
...
//// ПРИМЕР 6 _Промежуточный. Всё работает. Пройдена 26 19 мин
//// Дорабатываем Пример 3 _РАБОТАЕТ! Создаёт 3 кнопки и обрабатывает их, и создаёт лишнюю надпись "Команда не из кнопки".
//// И обрабатывает только одно изображение _Использован бот №2
//import org.telegram.telegrambots.bots.TelegramLongPollingBot;
//import org.telegram.telegrambots.meta.api.methods.GetFile;
...
//// ПРИМЕР 4 _Промежуточный. Всё работает. До 10 58 мин в видео. До создания метода SendPhoto runPhotoFilter
//// Дорабатываем Пример 3 _РАБОТАЕТ! Создаёт 3 кнопки и обрабатывает их, и создаёт лишнюю надпись "Команда не из кнопки".
//// И обрабатывает только одно изображение _Использован бот №2
//import org.telegram.telegrambots.bots.TelegramLongPollingBot;
//import org.telegram.telegrambots.meta.api.methods.GetFile;
