...
public class Task9_8_1_part3 {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Создан Telegram бот:\n" +
                ...
                "‘task9_8_1_part3’ - обрабатывает одно изображение\n" +
                "- второе в папке package:\n" +
                "‘task9_8_1_part3’ - обрабатывает несколько изображений\n");
        System.out.println("Отредактированные изображения сохраняются в папке `src/main/java/task9_8_1_part3/images`.");
