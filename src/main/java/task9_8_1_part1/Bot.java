...
import task9_8_1_part1.utils.PhotoMessageUtils;
...
public class Bot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        final String localFileName = "src/main/java/task9_8_1_part1/" + "cloned_image.jpg";
        ...
        for (int rowIndex = 0; rowIndex < rowCount; rowIndex++) {
            ...
            for (int columnIndex = 0; columnIndex < columnCount; columnIndex++) {
                if (rowIndex == 0 && columnIndex == 0) {
                    try {
                        Class<?> filterOperationClass = Class.forName("task9_8_1_part1.functions.FilterOperation");
...
//import org.telegram.telegrambots.meta.api.objects.replykeyboard.buttons.KeyboardRow;
//import org.telegram.telegrambots.meta.exceptions.TelegramApiException;
//import task9_8_1_part1.commands.AppBotCommand;
//import task9_8_1_part1.commands.BotCommonCommands;
//import task9_8_1_part1.functions.FilterOperation;
//import task9_8_1_part1.utils.PhotoMessageUtils;
//
//import java.io.*;
//import java.lang.reflect.InvocationTargetException;
...
//import java.util.ArrayList;
//
//import static task9_8_1_part1.utils.PhotoMessageUtils.processingImage;
//
//public class Bot extends TelegramLongPollingBot {
//
