...
public class Task9_2_0_VideoUrok {
...
//        настройка pom.xml на видео на мин 08 24

        System.out.println("Файл с ответом по заданию называется 'ОТВЕТ ПО УРОКУ', сохранен в папке " +
                "src/main/java/task9_2_0_VideoUrok");

        TelegramBotsApi api = new TelegramBotsApi(DefaultBotSession.class);

        BotSession botSession = api.registerBot(new Bot_VideoUrok());
//        botSession.setToken("");
    }
}
