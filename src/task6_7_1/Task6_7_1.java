...
public class Task6_7_1 {
    public static void main(String[] args) {
        ...
        for (String name : originalDatabase.keySet()) {
            System.out.println(name + ": " + originalDatabase.get(name));
        }
        ...
        while (true) {
            System.out.println("""
                    Введите имя студента и его оценку через запятую (например, 'Petya,5'),
                    можно ввести нового студента, например 'Vasya,5',
                    или введите 'end' для завершения программы:\s""");
            ...
            try {
                ...
                System.out.println("Ошибка ввода оценки. Попробуйте еще раз.");
                continue;
            }
