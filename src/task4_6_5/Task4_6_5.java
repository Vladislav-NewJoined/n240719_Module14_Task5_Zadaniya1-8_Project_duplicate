    ...
    public static void main(String[] args) {
        System.out.println("""
                ...
                Модуль 4. Наследование. Задание №6:\s
                    4. Создайте 10 классов-исключений. Соберите их в матрицу 3x3. Пусть пользователь выбирает,
                       номер строки и столбца, какое исключение выбросить. Если ввод неверный - выбросить 10-е исключение.\s
