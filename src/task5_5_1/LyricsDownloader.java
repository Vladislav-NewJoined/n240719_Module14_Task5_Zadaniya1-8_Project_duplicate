...
public class LyricsDownloader extends SongLyrics {
...
//                Задание:\s
//                Модуль 5. Интерфейсы, абстрактные классы, статические методы. Задание №5:\s
//                    1. Создайте абстрактный класс SongLyrics, который возвращает текст песни по названию.\s
//
//                Решение:\s""");
//
//        LyricsDownloader lyricsDownloader = new LyricsDownloader();
...
//        System.out.println("Lyrics for " + song + " by " + artist + ":\n" + lyrics);
//    }
//
//    @Override
...
//// ПРИМЕР 2 _работает, но без абстрактного класса SongLyrics
//import java.io.IOException;
//import java.io.BufferedReader;
//import java.io.InputStreamReader;
//import java.net.HttpURLConnection;
...
//
//        try {
//            String lyrics = downloadLyrics(artist, song);
//            System.out.println("Lyrics for " + song + " by " + artist + ":\n" + lyrics);
//        } catch (IOException e) {
